...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './aie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AIE actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_AIE actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_AIE actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_AIE actions', async () => {
      const arg = 42666;
